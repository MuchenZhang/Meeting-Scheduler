...
<body>
  ...
  <div id="box">
    ...
    <form action="test.php" method="POST">
      <p>
        <label style="position: relative; left: -150%;">Username: </label>
        <input type="text" id="user" name="user" > <!-- style="position: relative; left: -100%;" -->
      </p>
      <p>
        <label style="position: relative; left: -150%;">Password: </label>
        <input type="password" id="pass" name="pass" > <!-- style="position: relative; left: -100%;" -->
      </p>
      <p>
...
//conn to db
  ...
  ?>
    ...
    <?php
/*meetingDate >= DATE_ADD(CURDATE(),INTERVAL - '30' DAY);*/
    $sql = "SELECT * FROM inputs WHERE username='$loginusername'";
